...
C0 = state.ParticleInertia; % 0.729843788;
...
lowerinertia = 0.4 ;
upperinertia = max(0.9,lowerinertia) ;%0.9
...
state.ParticleInertia = max(upperinertia - ...
    (upperinertia-lowerinertia)*(state.Generation-1)/50, lowerinertia);
end
